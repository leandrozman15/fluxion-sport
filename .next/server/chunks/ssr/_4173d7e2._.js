...
"[project]/src/app/dashboard/superadmin/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SuperAdminPage() {
    ...
    const handleCreateClient = async (e)=>{
        ...
        setLoading(true);
        try {
            const clubId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(db, "clubs")).id;
            const clubDoc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(db, "clubs", clubId);
            // 1. Crear el Club en Firestore
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])(clubDoc, {
                id: clubId,
                name: form.clubName,
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, form.adminEmail, form.adminPassword);
            setSuccess(true);
            toast({
                title: "Sistema Desplegado",
                description: `El club ${form.clubName} ha sido creado. Se reiniciará la sesión para activar el acceso.`
            });
        } catch (error) {
            console.error(error);
            toast({
...
//# sourceMappingURL=_4173d7e2._.js.map