...
function DashboardRedirectPage() {
    _s();
    const { user, firestore, isUserLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirebase"])();
            ...
            async function bindIdentityAndRedirect() {
                ...
                try {
                    ...
                    if (!finalProfile && email) {
                        ...
                        const snapStaff = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(qStaff);
                        if (!snapStaff.empty) {
                            ...
                            const snapPlayer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(qPlayer);
                            if (!snapPlayer.empty) {
                    ...
                    if (finalProfile) {
                        ...
                        if (role === 'club_admin') return router.replace("/dashboard/clubs/".concat(finalProfile.clubId));
...
_s(DashboardRedirectPage, "oZui0ihHBVOj/yUHpliRwygAakk=", false, function() {
    return [
