        ...
        "Home.useEffect": ()=>{
            ...
            if (!user) {
                ...
                const checkRoleAndRedirect = {
                    "Home.useEffect.checkRoleAndRedirect": async ()=>{
                        try {
                            var _user_email;
                            ...
                            if (role === 'admin' || role === 'fed_admin') {
                                ...
                                router.replace("/dashboard/clubs/".concat(clubId));
                            } else {
                ...
                }["Home.useEffect.checkRoleAndRedirect"];
...
_s(Home, "oZui0ihHBVOj/yUHpliRwygAakk=", false, function() {
    return [
...
//# sourceMappingURL=_4797d88e._.js.map